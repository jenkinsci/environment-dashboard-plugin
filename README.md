...
This Jenkins plugin creates a custom view which can be used as a dashboard to display the code release versions that have been deployed to specific test and production environments (or devices).
